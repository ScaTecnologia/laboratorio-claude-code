...
12. **Próximos (opcionais):** limpar os 9 avisos antigos do ESLint (variáveis não usadas em `src/server.js`, `src/routes/carrinho.js` e testes); planejar Node 24 → 26 LTS depois de 2026-10-28.
